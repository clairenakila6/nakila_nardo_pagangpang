<x-app-layout>
    ...
    <section class="p-8 rounded-lg">
        <div class="grid grid-cols-3 gap-5">
            {{-- card carousel here --}}
            <div class="max-w-md">
                <img src={{ url('storage/diving1.png') }} alt="" class="rounded-lg w-full object-cover">
            </div>
            <div class="max-w-md">
                <img src={{ url('storage/diving2.png') }} alt="" class="rounded-lg w-full object-cover">
            </div>
            <div class="max-w-md">
                <img src={{ url('storage/diving3.png') }} alt="" class="rounded-lg w-full object-cover">
            </div>
        </div>
    </section>
